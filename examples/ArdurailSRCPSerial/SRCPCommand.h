...
namespace srcp
{
   ...
   * VERIFY Prueft die Einstellungen eines Elements
   */

  enum commands { 
    GET, SET, GO, CONNECTIONMODE, CHECK, WAIT, INIT, TERM, RESET, VERIFY, PROTOCOL, HELP, UNKNOWN   };
  enum devices { 
    POWER, FB, GA, GL, SM, DESCRIPTION, CV, LAN, NA   };
  ...
  // Protokoll zustaende
  enum { 
    UNDEFINED, HANDSHAKE, COMMAND, INFO   };
  // Power
  enum power_enum { 
    ON, OFF   };
}
